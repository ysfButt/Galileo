...
const InfoIcon = ({ className = '', width = '20', height = '20', fill="#D9D9D9" }) => ( 
  <svg className={className} width={width} height={height} viewBox="0 0 20 20" fill={fill} xmlns="http://www.w3.org/2000/svg">
